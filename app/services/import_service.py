...
def run_import(folder: Optional[str] = None) -> Dict:
    ...
    for xml_path in xml_files:
        ...
        try:
            ...
            invoice, created = _create_invoice_tree(invoice_dto, supplier.id, str(import_folder))
...
def _create_invoice_tree(invoice_dto: InvoiceDTO, supplier_id: int, import_source: str) -> Tuple[Invoice, bool]:
...
def _safe_log_import(
    *,
    ...
    """Scrive un log di import in transazione autonoma."""
    create_import_log(
        file_name=file_name,
        file_hash=file_hash,
